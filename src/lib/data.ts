...
export const counselors: CounselorInterface[] = [
  {
    ...
    approach:
      "당신의 감정을 충분히 이해할게요!<br/>제가 안전하고 따뜻한 환경에서<br/>자유롭게 감정을 표현할 수 있도록 도울게요!",
    personality:
      "저는 따뜻하고 공감적인 성향으로,<br/>내담자의 감정을 깊이 이해하고 위로를 제공해요.<br/>",
    greeting: (name: string) =>
      `안녕하세요. ${name}님, AGENT | GONG 이에요! 편안한 마음으로 이야기를 나누어 보세요. 오늘은 어떤 일로 저를 찾아오셨나요?`,
  ...
  },
  {
    ...
    type: "해결중심 상담사",
    description:
      "안녕하세요. AGENT | SOL 입니다.<br/>저는 냉철한 논리적 분석을 통해<br/>현실적인 솔루션을 제시하는 상담사입니다.<br/>해결이 필요하다면 저에게 말씀해주세요.",
    icon: Brain,
    color: "bg-analytical",
    ...
    approach:
      "체계적인 방법으로 문제를 분석하고<br/>단계별 해결 방안을 제시하여<br/>당신의 문제를 해결할 수 있게 돕겠습니다.",
    personality:
      "논리적이고 체계적인 성향으로,<br/>내담자에게 필요한 실용적인 해결책을 제공합니다.",
    greeting: (name: string) =>
